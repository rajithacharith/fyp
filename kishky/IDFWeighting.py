...
def getIDFDictionaryWithNgrams(datapath, n):
    ...
    for tempfile in files:
        # x=x+1
        # print(x)
        tempfile = open(datapath + tempfile,'r',encoding='utf-8')
        sentences = tempfile.readlines()
        for sentence in sentences:
    ...
    # print(ngramDic)
    for tempfile in files:
        txtfile = open(datapath + tempfile,'r',encoding='utf-8')
        idfDictionary[tempfile] = []
        sentences = txtfile.readlines()
        for sentence in sentences:
            ngramMax = 0
...
def getTFDictionaryWithNgrams(datapath, n):
    ...
    for tempfilename in files:
        tempfile = open(datapath + tempfilename,'r',encoding='utf-8')
        sentences = tempfile.readlines()
    ...
    # print(ngramDic)
    for tempfilename in files:
        txtfile = open(datapath + tempfilename,'r',encoding='utf-8')
...
def getTFWeightsForFile(filename, path, tfDictionary, weightings):
    tempfile = open(path + filename.replace("raw", "txt"),'r',encoding='utf-8')
    sentences = tempfile.readlines()
